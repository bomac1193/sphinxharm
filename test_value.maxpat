	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "TEST: v (value) object to pass ratio into pfft~. No in~, no receive~."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 110.0, 120.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "pfft~ test_value_sub 2048 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 30.0, 190.0, 42.0, 22.0 ],
					"text" : "*~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 320.0, 550.0, 20.0 ],
					"text" : "1. DSP on  2. Type 1.5 in ratio box  3. Should hear pitch shift up a 5th"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "flonum -> v object stores value. metro inside pfft~ polls it every 50ms."
				}
