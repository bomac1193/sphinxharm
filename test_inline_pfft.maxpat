	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "TEST: Inline pfft~ with embedded gizmo~. Type ratio to shift pitch."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "RATIO (1.5=fifth, 2.0=octave, 0.5=oct dn):"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 30.0, 160.0, 120.0, 22.0 ],
					"text" : "pfft~ 2048 4",
					"patcher" : 					{
						"fileversion" : 1,
						"appversion" : 						{
...
, 			{
				"box" : 				{
					...
					"text" : "Uses in~ 2 (not in~ 1) inside pfft~. Subpatch is EMBEDDED inline."
				}
